import unittest
from caaj_to_cryptact.caaj_to_cryptact import *
...
class TestCaajToCryptact(unittest.TestCase):
  def test_fee(self):
    ...
    cryptact_line = CaajToCryptact.convert(caaj_lines[0])
  ...
  def test_staking_reward(self):
    caaj_lines = CaajFileHandler.get_caaj_lines('%s/../testdata/simple_kava_caaj.csv' % os.path.dirname(__file__))
    cryptact_line = CaajToCryptact.convert(caaj_lines[8])
  ...
  def test_lending_reward(self):
    caaj_lines = CaajFileHandler.get_caaj_lines('%s/../testdata/simple_kava_caaj.csv' % os.path.dirname(__file__))
    cryptact_line = CaajToCryptact.convert(caaj_lines[34])
  ...
  def test_swap(self):
    ...
    cryptact_line = CaajToCryptact.convert(caaj_lines[4])
    ...
    self.assertEqual(cryptact_line.price, '6.33235424583')
